    ...
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        <div className="user-mini">
          ...
          <div>
            <strong>{session?.name || 'Signed in user'}</strong>
        ...
        <button
          className="logout"
          onClick={() => {
            localStorage.removeItem('labelix_token');
            localStorage.removeItem('labelix_user');
